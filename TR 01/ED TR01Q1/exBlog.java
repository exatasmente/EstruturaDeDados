...
public class exBlog extends JFrame implements
 ActionListener{
  ...
  public exBlog(){
    ...
    int codigo = 01;
         String nomeProduto = "OI";
         long quantidade =0;
         double precoProduto=0;
         String fabricante="E";
         String tipo="2";
    ArrayList<Produtos> P = new ArrayList<> ();
    P.add(new Produtos(0,codigo,nomeProduto,quantidade,precoProduto,fabricante,tipo));
    int i;
    for(i=0;i<P.size();i++)
    {
        cmbNiv.addItem(P.get(i).getNome);
    }
